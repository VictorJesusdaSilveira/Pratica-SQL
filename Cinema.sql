...
create table personagem(
	codFilme varchar(3),
    codAtor varchar(3),
    codPersonagem varchar(3),
    personagem varchar(40) not null,
    cache1 int not null,
    primary key (codFilme , codAtor , codPersonagem),
    foreign key (codFilme) references filme (codFilme),
    foreign key (codAtor) references ator (codAtor)
);

insert into ator 
values ('a1' , 'Demi Moore' , 'Maria da Silva' , 'USA' , 'F' , 32 , null , null),
       ...
       ('a16' , 'Matt Damon' , 'Mattew Louis Damon' , 'USA' , 'M' , 40 , null , null),
...
insert into filme
values ('f1' , 'A Jurada' , 1996 , 1000000 , 18),
...
update ator
set nomeArtistico = 'William Hurt'
where codAtor = 'a10';
...
update filme
set orcamento = 20000000
where codFilme = 'f25';

update filme
set nomeFilme = 'Quem vai ficar com Mary'
where codFilme = 'f13';
...
update personagem
set personagem = 'Stanley Ipkiss'
where codAtor = 'a17';

update ator
set nomeReal = 'William Bradley Pitt'
where codAtor = 'a2';
